...
class Add_Librarian extends JFrame
{
    Connection con=null;
    ResultSet rs=null;
    Statement st=null;
    ...
    Add_Librarian()
    {
       ...
       //rs=st.executeQuery("select * from Register"); 
        ...
        JLabel lr=new JLabel("-:Add Librarian Form:-");
                ...
                else
                {
                    if(cbx.isSelected()==true)
                    {
                        try
                        {
                            ...
                            String s1="INSERT INTO Registration_Table(Name,Mobile,Password,Day,Month,Year,Gender,Address) VALUES('"+t1.getText()+"','"+t2.getText()+"','"+p1.getText()+"','"+day.getSelectedItem().toString()+"','"+month.getSelectedItem().toString()+"','"+year.getSelectedItem().toString()+"','"+rb+"','"+ta.getText()+"')";
                            String s2="INSERT INTO Login_Table(UserName,Password) VALUES('"+t1.getText()+"','"+p1.getText()+"')";
                            st.executeUpdate(s1);
                            st.executeUpdate(s2);

                            rs=st.executeQuery("SELECT * FROM Login_Table");
                            rs=st.executeQuery("SELECT * FROM Registration_Table");
                            while(rs.next())
                            ...
                            p1.setText("");
                            ta.setText("");
                            JOptionPane.showMessageDialog(null,"Librarian Successfully Registered");
                        }
