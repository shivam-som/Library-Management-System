...
class View_Librarian extends JFrame
{
    Connection con=null;
    ResultSet rs=null;
    Statement st=null;
	...
	try
        {
            ...
            PreparedStatement pst=con.prepareStatement("select * from Registration_Table",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
